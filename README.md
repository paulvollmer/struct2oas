# struct2oas ![](https://img.shields.io/badge/version-1.0.2-blue.svg) [![Build Status](https://travis-ci.org/paulvollmer/struct2oas.svg?branch=master)](https://travis-ci.org/paulvollmer/struct2oas)
